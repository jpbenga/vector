...
-> choix et iterations
-> formalisation visuelle validee
-> validation finale
-> implementation Flutter sur branche dediee ou main si decision explicite
-> visual QA
```
...
- Une capture, une maquette Penpot ou un asset valide explicitement peut servir de reference visuelle.
- Codex n'implemente jamais directement depuis une image brute non validee.
...
- [Apparence validee Lector Sport](07-validated-visual-redesign.md)
